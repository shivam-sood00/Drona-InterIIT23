...
class VisionPipeline():
    ...
    def init_aruco_detector(self):
        ...
        # 0.00930224
        self.dist_coef = np.zeros((5, 1)) #np.array([-0.0563891045749187, 0.0661624521017075, 9.07330249901861e-05, 6.26308901701123e-05, -0.0209800880402327]) #np.zeros((5, 1))  #calib_data["distCoef"]

        """dist_coef = np.zeros((5, 1))"""
        self.cam_rvec = np.array([0.12747728, -3.03007291, -0.31749833]) #np.array([1.63839208 ,-1.83514309, -0.16816304]) #np.array([0.26238109, -3.30088755, -0.07543371]) #np.array([-2.97019626, -0.3456304, 0.31979031]) #calib_data["rVector"] #
        self.cam_tvec = np.array([27.30823905, 4.2448156, 277.09033646]) #np.array([80.50181036, 54.45316379, 286.19400413]) #np.array([11.56079921, -13.0814128,  271.02415795])
