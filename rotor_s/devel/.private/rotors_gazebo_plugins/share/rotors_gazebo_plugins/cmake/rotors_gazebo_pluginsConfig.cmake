...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/aditya/rotor_s/src/rotors_simulator/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/aditya/rotor_s/devel/.private/rotors_gazebo_plugins)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/aditya/rotor_s/install)
...
if(NOT "/home/aditya/rotor_s/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/local/include/opencv4 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/aditya/rotor_s/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/local/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aditya/rotor_s/src/rotors_simulator/rotors_gazebo_plugins/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rotors_gazebo_plugins_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rotors_gazebo_motor_model;rotors_gazebo_controller_interface;/usr/local/lib/libopencv_calib3d.so.4.6.0;/usr/local/lib/libopencv_core.so.4.6.0;/usr/local/lib/libopencv_dnn.so.4.6.0;/usr/local/lib/libopencv_features2d.so.4.6.0;/usr/local/lib/libopencv_flann.so.4.6.0;/usr/local/lib/libopencv_gapi.so.4.6.0;/usr/local/lib/libopencv_highgui.so.4.6.0;/usr/local/lib/libopencv_imgcodecs.so.4.6.0;/usr/local/lib/libopencv_imgproc.so.4.6.0;/usr/local/lib/libopencv_ml.so.4.6.0;/usr/local/lib/libopencv_objdetect.so.4.6.0;/usr/local/lib/libopencv_photo.so.4.6.0;/usr/local/lib/libopencv_stitching.so.4.6.0;/usr/local/lib/libopencv_video.so.4.6.0;/usr/local/lib/libopencv_videoio.so.4.6.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/aditya/rotor_s/devel/.private/rotors_gazebo_plugins/lib;/home/aditya/rotor_s/devel/lib;/opt/ros/noetic/lib)
