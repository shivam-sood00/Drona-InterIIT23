...
class Drone_control: 
    ...
    def position_controller(self):
        ...
        if abs(self.err_r[0])>0.04 and abs(self.err_r[1])>0.04 and abs(self.err_r[2])>0.04:
            self.rddot_c[0] = self.rddot_des[0] + self.kx[0]*self.err_r[0] + self.kx[1]*self.err_rdot[0] + self.kx[2]*self.integral_err_r[0]
            self.rddot_c[1] = self.rddot_des[1] + self.ky[0]*self.err_r[1] + self.ky[1]*self.err_rdot[1] + self.ky[2]*self.integral_err_r[1]
            self.rddot_c[2] = self.rddot_des[2] + self.kz[0]*self.err_r[2] + self.kz[1]*self.err_rdot[2] + self.kz[2]*self.integral_err_r[2]
        ...
        self.angle_des[1] = math.atan2(self.rddot_c[1]*math.sin(self.angle_des[0]),self.rddot_c[0])
