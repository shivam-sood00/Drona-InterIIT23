...
from utils import getBytes, getDec, getSignedDec, toUnsigned
            ...
            if buff[i] != headerArrayOut[i]:
                if i == 2:
                    ...
                    if index != -1:
                        ...
                        print(
                            "Error decoding buffer could not be resolved (direction does not make sense)...!!! IGNORED",
                            buff,
                        )
                        return [], 0, buff
        ...
        # case when complete message if present
            ...
            if checksum == buff[msgLen + 5]:
                ...
                if index != -1:
                    ...
                    print(
                        "Error decoding buffer could not be resolved (checksum does not match)...!!! IGNORED",
                        buff,
                    )
                    return [], 0, buff
        else:
